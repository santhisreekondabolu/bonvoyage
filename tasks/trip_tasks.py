...
class TripTasks:
    ...
    def plan_task(self, agent, start_city, destination_city, interests, start_date, end_date):
        ...
        return Task(
            ...
            - 💰 Full **budget breakdown** at the end for entire trip (stay, food, transport, tickets, etc.)  flight tickets budget (budget breakdown should include both onward and return price added), Give approximate cost of food.transport (mid to luxery range with a lower limit of 2000 per day), stay for entire trip duration
